	...
	<div class="container-wrapper">
		...
		<div class="container">
			<div class="page-header">
				<h1>Edit Product</h1>
				<p class="lead">Please update the information here:</p>
			</div>

			<!-- to upload file add the enctype multipart/form-data -->
			<form:form action="${pageContext.request.contextPath}/admin/productInventory/editProduct/${product.id}" method="post" enctype="multipart/form-data" commandName="product">
